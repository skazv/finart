...
class BudgetsBoardView: UIView {
    let budgetsBoardColletion = BudgetsBoardCollection()
    
    private lazy var topBackgorundView: UIView = {
        let view = UIView()
        view.translatesAutoresizingMaskIntoConstraints = false
        view.backgroundColor = .systemBackground //.secondarySystemBackground
        return view
    }()
...
extension BudgetsBoardView {
    private func setupView() {
        backgroundColor = .systemBackground//.secondarySystemBackground
        
        addSubviews(views: [
            topBackgorundView,
            budgetsBoardColletion,
        ])
        ...
        NSLayoutConstraint.activate([
            ...
            budgetsBoardColletion.topAnchor.constraint(equalTo: topView.bottomAnchor, constant: 8),
            budgetsBoardColletion.leadingAnchor.constraint(equalTo: safeAreaLayoutGuide.leadingAnchor, constant: 8),
            budgetsBoardColletion.trailingAnchor.constraint(equalTo: safeAreaLayoutGuide.trailingAnchor, constant: -8),
            budgetsBoardColletion.bottomAnchor.constraint(equalTo: safeAreaLayoutGuide.bottomAnchor, constant: -8),
        ])
