...
class TransactionInteractor: TransactionInteractorInputProtocol {
    var presenter: TransactionInteractorOutputProtocol?
    ...
    func saveTransaction(budgetId: Int, toCellType: CellType, fromCell: Int, toCell: Int, name: String, count: Int, date: Date) {
        ...
        case .income:
            ...
            let newAccountCount = Int(accountsCD[toCell].count) + count
        ...
        case .account:
            ...
            let newToAccountCount = Int(accountsCD[toCell].count) + count
