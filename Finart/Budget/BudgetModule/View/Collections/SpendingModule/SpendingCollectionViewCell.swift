//
//  SpendingCollectionviewCell.swift
//  Finart
//
...
class SpendingCollectionViewCell: UICollectionViewCell {
    var spendingDelegate: SpendingCellDelegate?
    ...
    lazy var imageView: UIImageView = {
        ...
        imageView.contentMode = .scaleAspectFit //UIView.ContentMode.scaleAspectFit
        return imageView
    }()
...
extension SpendingCollectionViewCell {
    ...
    @objc private func deletePressed() {
        spendingDelegate?.delete(cell: self)
    }
